...
public struct MarkdownEditorBus: Sendable {
    ...
    /// Posted by the host UI to insert an arbitrary source fragment at the
    /// current selection. Expected `userInfo["text"] as? String`.
    public var insertMarkdownRequest: Notification.Name?
    ...
    public init(
        ...
        insertMarkdownRequest: Notification.Name? = nil,
        ...
        self.insertMarkdownRequest = insertMarkdownRequest
